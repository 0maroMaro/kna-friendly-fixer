      ...
      <PageLayout>
        <div className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center text-white/70">Loading men's collection...</div>
          </div>
        </div>
      </PageLayout>
    );
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-white/70">
              Premium streetwear crafted for the modern man
            </p>
          </div>
          ...
          {products.length === 0 ? (
            <div className="max-w-md mx-auto text-center p-8 border border-white/10 rounded-lg bg-black/50">
              ...
              <h4 className="text-2xl font-semibold mb-4 text-white">No Men's Products</h4>
              <p className="text-white/70 mb-6">
                Check back soon for our men's collection!
              </p>
            </div>
          ) : (
